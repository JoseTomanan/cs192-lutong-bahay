...
test.describe('Recipe interactions', () => {
    ...
    test('UC0-S5 Recipe is successfully deleted', async ({ page }) => {
      ...
      await page.waitForTimeout(5000); // Wait for 5000 milliseconds
      ...
      await page.waitForSelector(`.RecipeCard:has-text("${recipeName}")`, { state: 'visible', timeout: 30000 });
      // await page.waitForSelector('.RecipeCard', { state: 'visible', timeout: 35000 });
