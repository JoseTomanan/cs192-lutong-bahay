...
test.describe('Assure webpages still working', () => {
    test('should load login page', async ({ page }) => {
        await page.goto('https://192-lutongbahay.vercel.app/login', { waitUntil: 'domcontentloaded' });
    ...
    test('should load dashboard page', async ({ page }) => {
        await page.goto('https://192-lutongbahay.vercel.app/dashboard', { waitUntil: 'domcontentloaded' });
    ...
    test('should load search page', async ({ page }) => {
        await page.goto('https://192-lutongbahay.vercel.app/search', { waitUntil: 'domcontentloaded' });
